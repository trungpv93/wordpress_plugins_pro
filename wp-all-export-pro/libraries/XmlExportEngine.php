	...
	{		
		...
		public function __construct( $post, & $errors = false ){		
			...
			{ 
				...
				self::$is_auto_generate_enabled = (class_exists('WooCommerce') and in_array(self::$post_types[0], array('product', 'shop_coupon', 'shop_customer')) or in_array(self::$post_types[0], array('users')));
